...
class MyScene extends THREE.Scene {
  constructor (myCanvas) {
    ...
    this.taza.position.x = -13;
    this.add (this.taza);
    this.escuadra = new Escuadra(this.gui, "Controles de la escuadra");
    this.add(this.escuadra);
    this.tuerca = new Tuerca(this.gui, "Controles de la tuerca");
    this.tuerca.position.x = +22.5;
