...
class Cono extends THREE.Object3D {
  constructor(gui,titleGui) {
    ...
    var conoGeom = new THREE.ConeBufferGeometry (this.guiControls.radio, this.guiControls.altura, this.guiControls.resolucion);
  ...
  update () {
    this.cono.geometry = new THREE.ConeBufferGeometry(this.guiControls.radio, this.guiControls.altura, this.guiControls.resolucion);
    this.cono.material.flatShading = this.parent.guiControls.flatShading;
